import MusicManager, { SLOT_SOUND_TYPE } from "./MeowHiLo.Sound";
...
export default class Guide extends cc.Component {
  ...
  // private updateLabel() {
  //   let bet =
  //     Controller.instance.listBet[Controller.instance.betOrdi];
  ...
  private onClickBack() {
    MusicManager.instance.playType(SLOT_SOUND_TYPE.BUTTON);
