...
export namespace Cmd {
  ...
  //5008
  export class ReceiveFreeGame extends BGUI.BaseInPacket {
    public data: ImpData = {
      betAmount: -1,
      cellSize: 0,
      listCell: [],
  ...
  // 4: Đang có minigame
  //5005
  export class ReceiveBetFailed extends BGUI.BaseInPacket {
  ...
  //5010
  export class ReceiveMiniGame extends BGUI.BaseInPacket {
    public miniGame: ImpMini = {
      betAmount: -1,
      isActionEmpty: false,
      listActionsSize: -1,
  ...
  export class Send {
    ...
    public static sendStartFreeGame() {
      let pk = new SendStartFreeGame();
      Connector.instance.sendPacket(pk);
    }

    public static sendStartMiniGame() {
      let pk = new SendStartMiniGame();
      Connector.instance.sendPacket(pk);
    }
  }
  ...
  //5008
  export class SendStartFreeGame extends BGUI.BaseOutPacket {
    getCmdId(): number {
      return Cmd.CMD__FREE_GAME_RESULT;
    }
    putData(): void {}
  }

  //5010
  export class SendStartMiniGame extends BGUI.BaseOutPacket {
    getCmdId(): number {
      return Cmd.CMD__OPEN_MINIGAME;
    }
    putData(): void {}
  }
