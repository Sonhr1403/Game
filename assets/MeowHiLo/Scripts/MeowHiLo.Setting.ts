...
// import MeowHiLoMusicManager, { SLOT_SOUND_TYPE } from "./MeowHiLo.Music";

const { ccclass, property } = cc._decorator;
@ccclass
export default class MeowHiLoSetting extends cc.Component {
  public static instance: MeowHiLoSetting = null;
  ...
  private sliderVolumeCallback(slider: cc.Slider, customEventData: string) {
    ...
    // MeowHiLoMusicManager.instance.setSystemVolume(this.volumeSlider.progress);
  ...
  private toggleLanguageOptions() {
    // MeowHiLoMusicManager.instance.playType(SLOT_SOUND_TYPE.BTN_CLICK);
  ...
  private toggleMusic() {
    // MeowHiLoMusicManager.instance.playType(SLOT_SOUND_TYPE.BUTTON);
    this.musicEnabled = !this.musicEnabled;
    this.updateMusic();
    // MeowHiLoMusicManager.instance.setMusicStatus(this.musicEnabled);
  }
  ...
  private updateMusic() {
    if (this.musicEnabled === false) {
      ...
      // MeowHiLoMusicManager.instance.setSystemVolume(0);
      // MeowHiLoMusicManager.instance.pauseSlotMusic();
    } else {
      ...
      // MeowHiLoMusicManager.instance.setSystemVolume(this.volumeSlider.progress);
      // MeowHiLoMusicManager.instance.resumeSlotMusic();
    }
  }
